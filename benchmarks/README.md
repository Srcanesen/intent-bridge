...
V4 koşum hatasını düzelten [`source-grounded-evidence-v5`](source-grounded-evidence-v5/README.md), v4 ile aynı promptları/korpusu kullanır ve birleştirme sonrası açık Türkçe onay ile 184 kümülatif işlem tavanını kapsar.
